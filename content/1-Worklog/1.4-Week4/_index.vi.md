...
| 2 | Thiết kế VPC với EC2 và RDS; ban đầu chọn RDS PostgreSQL private Single-AZ để so sánh chi phí trước khi nâng lên Multi-AZ. | 22/06/2026 | 25/06/2026 | [Amazon VPC User Guide](https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html) |
...
* Thiết kế được kiến trúc AWS bám sát chương trình hiện tại:
  ...
  * PostgreSQL trên RDS private; phương án ban đầu là Single-AZ.
